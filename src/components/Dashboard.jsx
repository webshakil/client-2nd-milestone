//drodown problem solved
// import React, { useState, useEffect, useCallback, memo } from 'react';
// import { useAuth } from '../contexts/AuthContext';
// import { useSecurity } from '../contexts/SecurityContext';
// import ComingSoon from './Dasbaord/ComingSoon';

// // Stable dropdown component to prevent re-renders
// const StableUserManagement = memo(({ 
//   usaNames, 
//   selectedUserId, 
//   selectedAdminRole, 
//   selectedUserType, 
...
//   const handleAdminRoleChange = useCallback((e) => {
//     setSelectedAdminRole(e.target.value);
//   }, []);
...
//   const handleSubscriptionChange = useCallback((e) => {
      ...
      <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
        ...
        <button className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg text-sm">
          Configure Types
            ...
            //             value={selectedUserId}
            //             onChange={(e) => setSelectedUserId(e.target.value)}
            //             className="appearance-none w-full px-3 py-3 pr-8 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-900"
            //             disabled={isUpdatingRole}
            //           >
            //             <option value="">Choose a user</option>
            //             {usaNames.map((name, index) => (
...
//this file is excellent and just to make part by part above code
// import React, { useState, useEffect } from 'react';
// import { useAuth } from '../contexts/AuthContext';
// import { useSecurity } from '../contexts/SecurityContext';
// import ComingSoon from './Dasbaords/ComingSoon';
