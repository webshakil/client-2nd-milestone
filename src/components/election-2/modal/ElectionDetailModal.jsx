// src/components/ElectionDetailModal.jsx
...
import LotteryVotingDemo from './LotteryVotingDemo';
...
const ElectionDetailModal = ({ isOpen, onClose, electionId }) => {
  ...
  const [showLotteryDemo, setShowLotteryDemo] = useState(false);
                      ...
                      <>
                        {election.pricing_type === 'free' ? (
                          <button
                            ...
                            className="flex-1 inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
                          >
                        ...
                        {election.pricing_type === 'free' ? (
                          ...
                          <>
                            ...
                            <button
                              onClick={handleVoteAction}
                              disabled={getElectionStatus(election) === 'completed'}
                              className={`flex-1 inline-flex items-center justify-center px-6 py-3 border border-gray-300 text-base font-medium rounded-md ${
                                getElectionStatus(election) === 'completed'
...
//this is last excellent code with vote and pay seperate button
// import React, { useState, useEffect } from 'react';
// import { useNavigate } from 'react-router';
// import { toast } from 'react-hot-toast';
// import {
...
//       <div className="relative top-20 mx-auto p-6 border w-11/12 md:w-2/3 lg:w-1/2 xl:w-1/3 shadow-lg rounded-lg bg-white">
...
//                 ${election.participation_fee || election.regional_fees?.region1 || 0}
//               </span>
//             </div>
//           </div>
...
// export default ElectionDetailModal;
//this is the last workable code just to add payment modal we add above code
// import React, { useState, useEffect } from 'react';
// import { useNavigate } from 'react-router';
// import { toast } from 'react-hot-toast';
// import {
