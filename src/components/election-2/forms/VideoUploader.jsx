//for video problem in render this code
...
const VideoUploader = ({
  ...
  // FIXED: Enhanced embed URL generation with production-ready parameters
  const getVideoEmbedUrl = (url) => {
    // YouTube - Use nocookie domain and add production-safe parameters
    const youtubeMatch = url.match(/(?:youtube\.com\/watch\?v=|youtu\.be\/)([a-zA-Z0-9_-]+)/);
    if (youtubeMatch) {
      const videoId = youtubeMatch[1];
      const origin = typeof window !== 'undefined' ? encodeURIComponent(window.location.origin) : '';
      return `https://www.youtube-nocookie.com/embed/${videoId}?enablejsapi=1&origin=${origin}&rel=0&modestbranding=1&fs=1&cc_load_policy=0&iv_load_policy=3&autohide=1`;
    }

    // Vimeo - Add responsive and security parameters
  ...
  return (
    <div className={`${className}`}>
      ...
      {/* Video Preview - ENHANCED with better error handling */}
...
//below code works perfectly in localhost but not in render
// import React, { useState, useRef } from 'react';
// import { Upload, X, Video, AlertCircle, Check, Eye, Play, Link, ExternalLink } from 'lucide-react';
