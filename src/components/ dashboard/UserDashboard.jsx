...
//import Wallet from '../milestone3/Wallet';
//import Subscriptions from '../milestone3/Subscriptions';
//import LotteryDashboard from '../milestone3/LotteryDashboard';
      ...
      <div className="border-b border-gray-200">
        <nav className="-mb-px flex space-x-8 overflow-x-auto">
          {[
            ...
            { id: 'biometric', name: 'Biometric', icon: DocumentTextIcon },
            { id: 'device', name: 'Device', icon: DocumentTextIcon },
            { id: 'wallet', name: 'Wallet', icon: WalletIcon },
            { id: 'subscriptions', name: 'Subscriptions', icon: CreditCardIcon },
            { id: 'lottery', name: 'Lottery', icon: TrophyIcon }
          ].map((tab) => {
...
export default UserDashboard;
 //this is the last workable code. to add lottery and payment above code
// import React, { useState, useEffect } from 'react';
// import { Link } from 'react-router';
// import { useAuth } from '../../contexts/AuthContext';
// import { useSecurity } from '../../contexts/SecurityContext';
