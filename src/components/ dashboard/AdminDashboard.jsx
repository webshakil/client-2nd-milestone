...
const AdminDashboard = () => {
  ...
  // Helper function to check if user can access fraud management
  const canAccessFraudManagement = () => {
    // Get user data from localStorage to match fraud system
    try {
      ...
      if (userData) {
        ...
        if (user.role) {
          ...
          const allowedRoles = ['manager', 'admin', 'auditor', 'analyst'];
    ...
    return hasPermission('view_audit') || canManageUsers();
  };
  ...
  const tabs = [
    ...
    { id: 'fraud', name: 'Fraud Management', show: canAccessFraudManagement() },
  ...
  return (
    <div className="space-y-6">
      ...
      {activeTab === 'fraud' && canAccessFraudManagement() && (
        <div>
          <FraudManagement />
        </div>
      )}
