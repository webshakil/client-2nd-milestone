...
const AccessDenied = ({ requiredRoles = [], requiredPermissions = [], currentRole = 'user' }) => {
  return (
          ...
          <div className="text-center">
            ...
            <div className="mt-6 bg-gray-50 rounded-lg p-4">
              <div className="text-sm text-gray-700">
                <p className="font-medium">Your current role: <span className="capitalize text-blue-600">{currentRole}</span></p>
                ...
                {requiredPermissions.length > 0 && (
                  <p className="mt-2">
                    <span className="font-medium">Required permissions:</span> {requiredPermissions.join(', ')}
                  </p>
                )}
              </div>
            </div>
